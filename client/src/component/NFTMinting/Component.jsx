...
const NFTMintingComponent = ({
  ...
  const sendTransactionReq = async (registData) => {
    ...
    const saved = (
      await axios.post(
        "http://localhost:8080/api/nft/save",
        registData.saveData
      )
    ).data;
    console.log(saved);
              ...
              {signLoading && (
                <Loading>
                  <img
                    width={"35%"}
                    alt=""
                    src={`https://steamuserimages-a.akamaihd.net/ugc/586909633581902758/BCAF264131B1B1792A7F985BFDCB749844A7DB8B/?imw=512&&ima=fit&impolicy=Letterbox&imcolor=%23000000&letterbox=false`}></img>
